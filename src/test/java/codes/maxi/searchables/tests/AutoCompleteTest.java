package codes.maxi.searchables.tests;

import codes.maxi.searchables.lang.StringSearcher;
import codes.maxi.searchables.TestConstants;
import codes.maxi.searchables.api.TokenRange;
import codes.maxi.searchables.api.autcomplete.CompletionSuggestion;
import codes.maxi.searchables.api.autcomplete.CompletionVisitor;
...
public class AutoCompleteTest {
    ...
    private CompletionSuggestion suggestion(String suggestion, String display, String suffix, int rangeStart, int rangeEnd) {
        ...
        return new CompletionSuggestion(suggestion, display, suffix, TokenRange.between(rangeStart, rangeEnd));
    }
